            ...
            <div class="col-12">
                <div>
                    ...
                    <form method="post" style="display: inline;">
                        @csrf
                        @method('DELETE')
                    <button formaction="{{ route('genders.destroy',$gender->id) }}" type="submit" class="btn btn-danger" onclick='return confirm("削除しますか？");'>削除</button>
                    </form>
                    
                    <form method="post" action={{ route('genders.update',$gender->id) }} style="display: inline;">
                        @csrf
                        @method('patch')
                    ...
                    <div class="col-lg-6">
                        <div class="card card-success">
                            ...
                            <div class="card-header" style="background-color:#77B1A1">
                                <h3 class="card-title">性別</h3>
                            </div>
                            
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="category">名称</label>
                                    <input type="text" value="{{ $gender->content }}"
