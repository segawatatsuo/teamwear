            ...
            <div class="col-12">
                <div>
                    ...
                    <form method="post" style="display: inline;">
                        @csrf
                        @method('DELETE')
                    <button formaction="{{ route('categories.destroy',$category->id) }}" type="submit" class="btn btn-danger" onclick='return confirm("削除しますか？");'>削除</button>
                    </form>
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $category->content }}"
